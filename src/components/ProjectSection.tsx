...
export default function ProjectSection() {
  const projects: Project[] = [
    ...
    {
      titulo: "Comercio de moda e vestuario",
      link: "https://loja-modelo-mateus.vercel.app/",
      desc: "Loja bnlasodksaoid jasiodas djsaiod jasiod jasiodj as dsaidjas",
      fotos: [
        "/lojcarrinho.png",
        "/lojabanner.png",
        "/lojacategoria.png",
  ...
  return (
    <main className="flex flex-col flex-1 bg-slate-100">
      <div className="flex justify-center my-8 rounded-sm shadow-sm">
      ...
      {projects.map((i, index) => {
        return (
          <div
            className={
              "flex border rounded-lg p-4 shadow-lg gap-5 " +
              (index % 2 === 0
